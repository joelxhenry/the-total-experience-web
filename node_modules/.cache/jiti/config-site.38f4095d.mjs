"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.siteConfig = exports.getInstructorFullName = exports.getFullAddress = exports.getFormattedPhone = exports.default = void 0; // Site Configuration
// Update these values to customize your website
const siteConfig = exports.siteConfig = {
  ...
  instructor: {
    ...
    bio: `Having worked in critical care for over 8 years, I understand firsthand how crucial proper BLS and ACLS training is. 
          These skills aren't just certifications – they're life-saving tools that can make the difference in emergency situations. 
          My mission is to provide comprehensive, hands-on training that builds confidence and competence. I believe in creating 
          a supportive learning environment where healthcare professionals can master these essential skills through practical 
          experience and real-world scenarios.`
  },
  ...
  assets: {
    ...
    instructorImageFallback: 'https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80',
...
exports.getFormattedPhone = getFormattedPhone;const getInstructorFullName = () => {
  return `${siteConfig.instructor.name}, ${siteConfig.instructor.credentials}`;
};

// Helper function to get complete address
exports.getInstructorFullName = getInstructorFullName;const getFullAddress = () => {
  return siteConfig.address.full;
};

// Export default for easy importing
exports.getFullAddress = getFullAddress;var _default = exports.default = siteConfig; /* v9-ed37b28e45a0c68e */
